...
./main.py -n 10                             -k rhos            -o results/psk-4-10000-rhos            data/psk_4_10000.txt
...
./main.py -n 10 -k bestmult -o results/psk-8-10000-bestmult data/psk_8_10000.txt
./main.py -l results/psk-8-10000-bestmult.json -k prudent -o results/psk-8-10000-prudent data/psk_8_10000.txt
